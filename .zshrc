...
# Path to your oh-my-zsh installation.
  export ZSH=/home/fernanda/.oh-my-zsh
...
plugins=(
  themes nyan history sudo colorize npm npx
)
...
alias runca='sh ~/workdev/servers/wildfly10-contaazul-1.0.0-SNAPSHOT/bin/standalone.sh -P ~/workdev/servers/wildfly10-contaazul-1.0.0-SNAPSHOT/standalone/configuration/contaazul.properties'
